...
Route::prefix('admin')->group(function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        // cheat monitoring
        Route::get('/cheat-monitor', [\App\Http\Controllers\Admin\CheatMonitorController::class, 'index'])->name('admin.cheat.index');
        Route::post('/cheat-monitor/unlock/{student}', [\App\Http\Controllers\Admin\CheatMonitorController::class, 'unlock'])->name('admin.cheat.unlock');
    });
});
