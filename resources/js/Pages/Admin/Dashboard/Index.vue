<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="alert alert-info border-0 shadow d-flex justify-content-between align-items-center">
                    <div>
                        <strong>Monitoring Kecurangan:</strong>
                        <span class="badge bg-danger ms-2">Akun Terkunci: {{ locked_students_count || 0 }}</span>
                        <span class="badge bg-warning text-dark ms-2">Log Kecurangan: {{ cheat_events_count || 0 }}</span>
                    </div>
                    <div>
                        <Link class="btn btn-sm btn-primary" href="/admin/cheat-monitor">Lihat Detail</Link>
                    </div>
                </div>
            </div>
        </div>
