    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/cheat-monitor') }">
                    <Link href="/admin/cheat-monitor" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-shield-exclamation icon icon-xs me-2" viewBox="0 0 16 16">
                                <path d="M5.072 0h5.856c.2 0 .395.06.56.171l3 2A1 1 0 0 1 15 3.763V8c0 4.418-3.582 8-8 8S-1 12.418-1 8V3.763a1 1 0 0 1 .512-.592l3-2A1 1 0 0 1 3.072 0h2z" transform="scale(.5) translate(8,0)"/>
                                <path d="M7.001 4.5a.5.5 0 0 1 1 0v3.993a.5.5 0 0 1-1 0V4.5zm.999 6a.999.999 0 1 1-1.998 0 .999.999 0 0 1 1.998 0z"/>
                            </svg>
                        </span>
                        <span class="sidebar-text">Monitoring Kecurangan</span>
                    </span>
                    </Link>
                </li>
